...
export function use1Cb() {
	const onClick = useCallback(callbackFactory("1", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
...
export function use2Cb() {
	const onClick = useCallback(callbackFactory("2", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
...
export function use3Cb() {
	const onClick = useCallback(callbackFactory("3", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
...
export function use4Cb() {
	const onClick = useCallback(callbackFactory("4", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
